...
if ($driverName === 'sqlite') {
    // Автоматическая конвертация диалекта PostgreSQL в SQLite
...
try {
    $pdo->exec($sql);
    echo "База данных успешно инициализирована для драйвера [{$driverName}] из единого файла database.sql!\n";
